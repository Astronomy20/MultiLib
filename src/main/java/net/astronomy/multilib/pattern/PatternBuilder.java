...
public class PatternBuilder {
    ...
    public PatternBuilder(boolean is3D) { this.is3D = is3D; }

    public PatternBuilder key(char symbol, Block block) {
        blockMap.put(symbol, block); return this;
    }

    public PatternBuilder layer(String... rows) {
        layers.add(Arrays.asList(rows)); return this;
    }
    ...
    public PatternManager build() {
        ...
        PatternManager pattern = new PatternManager(blockMap, layers, is3D, action);
